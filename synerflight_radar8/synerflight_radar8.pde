...
void drawText() { // draws the texts on the screen
  ...
  //ext("200cm",width-width*0.070,height-height*0.0833);
    ...
    //5Meter graph
  text("100cm",width-width*0.465,height-height*0.0833);
  text("200cm",width-width*0.380,height-height*0.0833);
  text("300cm",width-width*0.295,height-height*0.0833);
  text("400cm",width-width*0.210,height-height*0.0833);
  text("500cm",width-width*0.125,height-height*0.0833);
